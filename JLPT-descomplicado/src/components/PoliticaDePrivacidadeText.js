...
export default function PoliticaDePrivacidadeText() {
  return (
    <div className={style.PreparingForJLPT_container}>
      <h1>Política Privacidade</h1>
      <p>
        A sua privacidade é importante para nós. É política do JLPT
        Descomplicado respeitar a sua privacidade em relação a qualquer
        informação sua que possamos coletar no site{" "}
        <a href="https://www.jlptdescomplicado.com/">JLPT Descomplicado</a>, e
      ...
      <div className={style.PreparingForJLPT_box}>
        ...
        <p>
          ...
          informação que o JLPT Descomplicado oferece no site e com caráter
        ...
        <p>
          ...
          (softwares) do JLPT Descomplicado, de seus fornecedores ou terceiros,
        ...
        <p>Esta política é efetiva a partir de 28 August 2023 15:31</p>
